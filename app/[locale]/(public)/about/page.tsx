    ...
    <main className="w-full overflow-hidden">
      ...
      >
        ...
        <div className="relative z-10 container mx-auto px-4 text-center sm:px-6 md:px-8">
          <span className="inline-flex items-center gap-2 rounded-full border border-white/20 bg-white/10 px-4 py-1.5 text-xs font-semibold tracking-wider text-[#E6BF8F] uppercase backdrop-blur-md">
            <Sparkles className="size-3.5" />
            <span>{t("badge")}</span>
          </span>

          <h1 className="mx-auto mt-6 max-w-4xl font-serif text-4xl leading-tight font-bold tracking-tight text-white sm:text-5xl lg:text-6xl">
            {t("heroTitle")}
          </h1>
          ...
          <div className="mt-10 flex flex-wrap items-center justify-center gap-4">
            <Link
              ...
              className={cn(
                buttonVariants({
                  className:
                    "h-auto rounded-full bg-[#7C4A27] px-8 py-3.5 text-base font-semibold text-white shadow-lg transition-transform hover:scale-105 hover:bg-[#60391E] dark:bg-[#C2733C] dark:hover:bg-[#AC6432]",
                })
              )}
            >
            ...
            <Link
              ...
              className={cn(
                buttonVariants({
                  variant: "outline",
                  className:
                    "h-auto rounded-full border-white/30 bg-white/10 px-8 py-3.5 text-base font-semibold text-white backdrop-blur-md hover:bg-white/20 hover:text-white",
                })
              )}
            >
        ...
        <div className="container mx-auto px-4 sm:px-6 md:px-8">
          ...
          <div className="mt-16 grid grid-cols-1 gap-8 md:grid-cols-2">
            ...
            <div className="group relative overflow-hidden rounded-[32px] border border-[#ECE6DB] bg-gradient-to-br from-amber-50/50 via-white to-orange-50/30 p-8 shadow-sm transition-all duration-300 hover:shadow-md dark:border-neutral-800 dark:from-neutral-900 dark:via-neutral-900 dark:to-amber-950/20">
              ...
              <div className="mt-8 border-t border-dashed border-[#ECE6DB] pt-6 dark:border-neutral-800">
                <Link
                  href="/offers"
                  className="inline-flex items-center gap-2 text-sm font-bold text-[#7C4A27] transition-colors hover:text-[#60391E] dark:text-[#C2733C]"
                >
                  <span>{t("ctaButton")}</span>
            ...
            <div className="group relative overflow-hidden rounded-[32px] border border-[#ECE6DB] bg-gradient-to-br from-stone-50/50 via-white to-emerald-50/30 p-8 shadow-sm transition-all duration-300 hover:shadow-md dark:border-neutral-800 dark:from-neutral-900 dark:via-neutral-900 dark:to-emerald-950/20">
              ...
              <div className="mt-8 border-t border-dashed border-[#ECE6DB] pt-6 dark:border-neutral-800">
                <Link
                  href="/register"
                  className="inline-flex items-center gap-2 text-sm font-bold text-emerald-700 transition-colors hover:text-emerald-800 dark:text-emerald-400"
                >
                  <span>{t("ctaPartner")}</span>
                  <ArrowRight className="size-4 rtl:rotate-180" />
                </Link>
              ...
              <div className="space-y-4 pt-2">
                <div className="flex items-start gap-3.5">
                  ...
                  <p className="text-sm text-muted-foreground">
                    <strong className="text-[#2B1B15] dark:text-neutral-200">
                      Historical Sales & Trends:
                    </strong>{" "}
                    Machine learning algorithms predict unsold stock based on
                ...
                <div className="flex items-start gap-3.5">
                  ...
                  <p className="text-sm text-muted-foreground">
                    ...
                    Every listed surplus item strictly adheres to fresh daily
                    standards and allergen disclosure.
                  </p>
                </div>
              </div>
            </div>
              ...
              <div className="relative rounded-3xl border border-[#ECE6DB] bg-white p-8 shadow-xl dark:border-neutral-800 dark:bg-neutral-900">
                <div className="flex items-center justify-between border-b border-border/50 pb-4">
                  <div className="flex items-center gap-3">
                    <div className="flex size-10 items-center justify-center rounded-xl bg-[#7C4A27] text-white">
                      <Brain className="size-5" />
                    </div>
                    <div>
                      <p className="font-serif text-sm font-bold text-[#2B1B15] dark:text-neutral-100">
                        RestoMind AI Engine
                      </p>
                ...
                <div className="mt-6 space-y-4">
                  <div className="space-y-2">
                    <div className="flex justify-between text-xs font-medium">
                      ...
                      <span className="text-[#7C4A27] dark:text-[#E68A49]">
                        Low (8 Units)
                      </span>
                    </div>
                    <div className="h-2 w-full overflow-hidden rounded-full bg-muted">
                      <div
                        className="h-full rounded-full bg-[#7C4A27]"
                        style={{ width: "35%" }}
                      />
                    </div>
                  </div>
                  ...
                  <div className="mt-6 flex items-center gap-3 rounded-2xl bg-[#FAF7F2] p-4 text-xs leading-relaxed text-muted-foreground dark:bg-neutral-800/60">
                    <Sparkles className="size-5 shrink-0 text-[#7C4A27] dark:text-[#E68A49]" />
                    <span>
                      Auto-converted surplus into 30% discounted daily offer bag
                      for local community rescue.
                    </span>
                  </div>
                </div>
              </div>
        ...
        <div className="relative z-10 container mx-auto px-4 text-center sm:px-6 md:px-8">
          ...
          <div className="mt-8 flex flex-wrap items-center justify-center gap-4">
            <Link
              ...
              className={cn(
                buttonVariants(),
                "h-auto rounded-full bg-[#7C4A27] px-8 py-4 text-base font-semibold text-white hover:bg-[#60391E] dark:bg-[#C2733C] dark:hover:bg-[#AC6432]"
              )}
            >
              {t("ctaButton")}
            </Link>
