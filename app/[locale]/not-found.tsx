  ...
  return (
    <CartProvider>
      ...
      <div className="flex min-h-[70vh] flex-col items-center justify-center px-4 py-20 text-center">
        ...
        <span className="font-heading select-none text-7xl font-extrabold text-primary/20 sm:text-9xl">
          {t("badge")}
        </span>
        ...
        <div className="mt-8 flex flex-wrap justify-center gap-3">
          <Link href="/" passHref>
            <Button className="h-auto rounded-full px-6 py-3">{t("backHome")}</Button>
          </Link>
